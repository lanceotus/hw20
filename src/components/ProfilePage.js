            ...
            <div className="profile">
                ...
                <div className="input_row_container">
                    <div className="input_container">
                        <label>Имя</label>
                        <input id="firstname_field" value={this.state.firstname} onChange={this.changeFirstname}/>
                    </div>
                    <div className="input_container">
                        <label>Фамилия</label>
                        <input id="lastname_field" value={this.state.lastname} onChange={this.changeLastname}/>
                    </div>
                </div>
                <div className="input_row_container">
                    <div className="input_container">
                        <label>e-mail</label>
                        <input id="email_field" value={this.state.email} onChange={this.changeEmail}/>
                    </div>
                </div>
